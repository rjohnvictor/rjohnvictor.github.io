...
export default function Experience({ dict }: Props) {
    ...
    if (ds.layout.experience === 'energy-timeline')
        return <ExperienceEnergyTimeline dict={dict} />;
    if (ds.layout.experience === 'reading-list')
        return <ExperienceReadingList dict={dict} />;
        ...
        >
            <div className="section-container">
                ...
                <div className={styles.cardList}>
                    {EXPERIENCE.map((job) => {
                        const localized = dict.experience.items[job.id];
                        return (
                            <div
                            ...
                            >
                                ...
                                <ul className={styles.bulletList}>
                                    {localized.bullets.map((bullet, i) => (
                                        <li
                                            key={i}
                    ...
                    {EXPERIENCE.map((job, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {/* Card */}
                                <div
                                    className={`ki-card exp-card ${styles.kiCard}`}
                                >
                                    <div className={styles.kiCardEnergyLine} />

                                    <div className={styles.kiCardHeader}>
                                        <div>
                                            <h3 className={styles.kiCardRole}>
                                                {localized.role}
                                            </h3>
                                            <p className={styles.kiCardCompany}>
                                                {job.company}
                                            </p>
                                        </div>
                                        <span className={styles.periodBadge}>
                        ...
                        return (
                            ...
                            >
                                <div className={styles.zenEntryHeader}>
                                    <p className={styles.zenCompany}>
                                        {job.company}
                                    </p>
                                    <span className={styles.zenPeriod}>
                                        {job.period}
                                    </span>
                                </div>

                                <h3 className={styles.zenRole}>
                                    {localized.role}
                                </h3>
                                ...
                                <div className={styles.zenBullets}>
                                    {localized.bullets.map((bullet, i) => (
                                        <p
                                            key={i}
                                            className={styles.zenBulletText}
                                        >
                                            {bullet}
                                        </p>
                                    ))}
